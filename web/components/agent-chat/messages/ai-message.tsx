...
export function AIMessage({
  ...
  const showSuggestions = !isStreaming && suggestions.length > 0 && onSuggestionClick;
          ...
          <div className="flex flex-col gap-1">
            {suggestions.map((s) => (
              <button
                ...
                className="group flex w-full items-center gap-2 rounded-lg border border-transparent bg-white/70 px-3 py-2 text-left text-xs text-default-700 shadow-sm transition-all hover:border-purple-300 hover:bg-white hover:shadow-md dark:bg-white/5 dark:text-white/70 dark:hover:border-purple-500/40 dark:hover:bg-white/10"
              >
