...
export default function ExtensionSuggestionOverlay() {
  return (
    <div className="absolute top-0 left-0 h-screen w-screen backdrop-blur-xs backdrop-invert-25">
      <div className="flex h-full w-full grid-rows-[max-content_auto] flex-col items-center py-10">
