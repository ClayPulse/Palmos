/* This file is a modification of the original vad-react from 
   https://github.com/ricky0123/vad/pull/107.
   It fixes the issue where stream is not stopped when the hook is paused.
*/
