...
In this package, it provides many useful hooks for your extension to interact with Pulse Editor Core via [Inter-Module Communication (IMC)](/guide/pulse-editor-app/extension-system/imc). 